...
public class Player : MonoBehaviour
{
    ...
    {
        bool isPlayerTouchingLadder = myCollider2D.IsTouchingLayers(LayerMask.GetMask("Climbing"));
    ...
    private void Jump()
    {
        bool isPlayerTouchingGround = myCollider2D.IsTouchingLayers(LayerMask.GetMask("Ground"));
